        ...
        <>
            ...
            <form onSubmit={formSubmit} class="space-y-4">
                ...
                <div>
                    ...
                    <textarea class="border rounded p-2 h-40" name="details" required="true"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input
                        class="border rounded p-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cyan-400"
                        type="datetime-local"
                        name="Početak"
                        required
                        minLength="6"
                ...
                <div>
                    ...
                    <button
                        class="w-full bg-slate-500 text-white font-medium py-3 rounded-lg shadow-md hover:bg-slate-600 transition"
                        type="reset"
                        value="Poništi"
                    >
                        Reset
